 ...
 */
namespace SmartOSC\Article\Block\Html;
...
class Pager extends Template
{
     ...
     * @var string
     */
    protected $_template = 'SmartOSC_Article::html/pager.phtml';
    ...
    public function __construct(Template\Context $context, Config $configData)
    {
    ...
    public function getLimit()
    {
        ...
        $limitConfig = $this->getRequest()->getParam($this->getLimitVarName()) == null ? $this->getDefaultLimitPerPageConfig() :  $this->getRequest()->getParam($this->getLimitVarName()) ;
        if ($limit = $limitConfig) {
    ...
    {
        $limitPerPage = intval($this->_configData->getGeneralConfig('limit_per_page'));
        return $limitPerPage;
    }
}
